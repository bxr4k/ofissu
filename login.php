...
<body class="login-page">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <!-- Sipariş ve Ödeme Bilgileri - Açılır/Kapanır -->
                <div class="row mt-4">
                    <div class="col-md-12">
                        <button class="btn btn-outline-warning btn-lg w-100 mb-3" type="button" onclick="toggleOrderInfo()">
                            <span id="toggleIcon">▼</span> Su Siparişi ve Ödeme Bilgileri
                        </button>
                        
                        <div id="orderInfoSection" style="display: none;">
    ...
    <script>
    // Sipariş bilgilerini aç/kapat
    function toggleOrderInfo() {
        const section = document.getElementById('orderInfoSection');
